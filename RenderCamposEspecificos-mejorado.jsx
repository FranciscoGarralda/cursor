...
const CamposCompra = ({ formData, handleInputChange, monedas, cuentas }) => {
...
const CamposVenta = ({ formData, handleInputChange, monedas, cuentas }) => {
...
// Componente para campos básicos (reutilizable)
const CamposBasicos = ({ formData, handleInputChange, monedas, cuentas, showComision = false }) => {
  return (
    <>
      <div className="grid grid-cols-2 gap-2">
        <div>
